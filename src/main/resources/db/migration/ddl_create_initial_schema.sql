    ...
    create table item_context_modifiers (
        catalog_context smallint check (catalog_context between 0 and 2),
        id uuid not null,
        item_id uuid,
        primary key (id)
    );
    ...
    alter table if exists catalog_category 
       add constraint FKiygfy3j6j2xbmkvu6w8p5th2c 
       foreign key (category_id) 
       references categories;

    alter table if exists catalog_category 
       add constraint FK89thjui7w5p2yfuhrl10hh3b8 
